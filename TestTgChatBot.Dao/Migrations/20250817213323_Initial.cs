...
namespace TestTgChatBot.Dao.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTests_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_IsActive_EndTime",
                table: "Tests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTests_CreatedAt",
                table: "UserTests",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_UserTests_TestId_Status_StartNotifiedAt",
                table: "UserTests",
                columns: new[] { "TestId", "Status", "StartNotifiedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_UserTests_UserProfileId_TestId_Status",
                table: "UserTests",
                columns: new[] { "UserProfileId", "TestId", "Status" });
        }
